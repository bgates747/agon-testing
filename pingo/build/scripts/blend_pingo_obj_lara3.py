...
# Get the directory where the current Blender file is located
blender_file_directory = os.path.dirname(bpy.path.abspath("//"))

# Set the directory where the OBJ files will be exported relative to the Blender file directory
relative_export_directory = "agon-testing/pingo/src/blender"
export_directory = os.path.join(blender_file_directory, relative_export_directory)
