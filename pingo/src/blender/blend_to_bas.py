...
if __name__ == '__main__':
    ...
    # Define relative paths based on the Blender file directory
    ...
    # Make sure the texture_file_name is properly constructed
    if not texture_file_name:
        texture_file_name = f'{base_filename}.png'
    uv_texture_png = os.path.join(current_blend_dir, texture_file_name)  # Correct path to the PNG file
    uv_texture_rgba8 = os.path.join(tgt_dir, f'{base_filename}.rgba8')
