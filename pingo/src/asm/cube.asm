...
sv:
    ...
    rst.lil $18
    ld hl,cube_vertices
    ld bc,cube_num_vertices*6 ; 2 bytes per vertex,3 vertices per triangle
...
; 6470 VDU 23,0,$A0,sid%; $49,2,mid%; cube_vertices%; : REM Set Mesh Vertex Indexes
smvi:
    ld hl,@smvi_beg
...
stci:
    ...
    jp @stci_end
@stci_beg:
; 6560 VDU 23,0, &A0, sid%; &49, 4, mid%; cube_vertices%; : REM Set Texture Coordinate Indexes
    db 23,0,$A0
    dw sid
    db $49,4
    dw mid
...
; 6570 FOR i%=0 TO cube_vertices%-1
; 6580   VDU 0;
; 6590 NEXT i%
zeroes:
