...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 0 ; command 0: create control structure
@w:   dw 0x0000
@h:   dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 1 ; command 1: define mesh vertices
@mid: dw 0x0000
@n:   dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 2 ; command 2: set mesh vertex indexes
@mid: dw 0x0000
@n:   dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 3 ; command 3: define texture coordinates
@mid: dw 0x0000
@n:   dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 4 ; command 4: set texture coordinate indexes
@mid: dw 0x0000
@n:   dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 5 ; command 5: define object
@oid: dw 0x0000
@mid: dw 0x0000
@bmid: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 6 ; command 6: set object x scale factor
@oid: dw 0x0000
@scalex: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 7 ; command 7: set object y scale factor
@oid: dw 0x0000
@scaley: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 8 ; command 8: set object z scale factor
@oid: dw 0x0000
@scalez: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 9 ; command 9: set object xyz scale factors
@oid: dw 0x0000
@scalex: dw 0x0000
@scaley: dw 0x0000
@scalez: dw 0x0000
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 10 ; command 10: set object x rotation angle
@oid: dw 0x0000
@anglex: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 11 ; command 11: set object y rotation angle
@oid: dw 0x0000
@angley: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 12 ; command 12: set object z rotation angle
@oid: dw 0x0000
@anglez: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 13 ; command 13: set object xyz rotation angles
@oid: dw 0x0000
@anglex: dw 0x0000
@angley: dw 0x0000
@anglez: dw 0x0000
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 14 ; command 14: set object x translation distance
@oid: dw 0x0000
@distx: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 15 ; command 15: set object y translation distance
@oid: dw 0x0000
@disty: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 16 ; command 16: set object z translation distance
@oid: dw 0x0000
@distz: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 17 ; command 17: set object xyz translation distances
@oid: dw 0x0000
@distx: dw 0x0000
@disty: dw 0x0000
@distz: dw 0x0000
...
; VDU 23, 0, &A0, sid; &48, 18, anglex; : Set Camera X Rotation Angle
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 18 ; command 18: set camera x rotation angle
@anglex: dw 0x0000
@end: db 0x00 ; padding

; Set Camera Y Rotation Angle
; VDU 23, 0, &A0, sid; &48, 19, angley; : Set Camera Y Rotation Angle
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 19 ; command 19: set camera y rotation angle
@angley: dw 0x0000
@end: db 0x00 ; padding

; Set Camera Z Rotation Angle
; VDU 23, 0, &A0, sid; &48, 20, anglez; : Set Camera Z Rotation Angle
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 20 ; command 20: set camera z rotation angle
@anglez: dw 0x0000
@end: db 0x00 ; padding

; Set Camera XYZ Rotation Angles
; VDU 23, 0, &A0, sid; &48, 21, anglex; angley; anglez; : Set Camera XYZ Rotation Angles
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 21 ; command 21: set camera xyz rotation angles
@anglex: dw 0x0000
@angley: dw 0x0000
@anglez: dw 0x0000
@end: db 0x00 ; padding
...
; VDU 23, 0, &A0, sid; &48, 22, distx; : Set Camera X Translation Distance
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 22 ; command 22: set camera x translation distance
@distx: dw 0x0000
@end: db 0x00 ; padding

; Set Camera Y Translation Distance
; VDU 23, 0, &A0, sid; &48, 23, disty; : Set Camera Y Translation Distance
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 23 ; command 23: set camera y translation distance
@disty: dw 0x0000
@end: db 0x00 ; padding

; Set Camera Z Translation Distance
; VDU 23, 0, &A0, sid; &48, 24, distz; : Set Camera Z Translation Distance
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 24 ; command 24: set camera z translation distance
@distz: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 25 ; command 25: set camera xyz translation distances
@distx: dw 0x0000
@disty: dw 0x0000
@distz: dw 0x0000
@end: db 0x00 ; padding
...
; VDU 23, 0, &A0, sid; &48, 26, scalex; : Set Scene X Scale Factor
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 26 ; command 26: set scene x scale factor
@scalex: dw 0x0000
@end: db 0x00 ; padding

; Set Scene Y Scale Factor
; VDU 23, 0, &A0, sid; &48, 27, scaley; : Set Scene Y Scale Factor
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 27 ; command 27: set scene y scale factor
@scaley: dw 0x0000
@end: db 0x00 ; padding

; Set Scene Z Scale Factor
; VDU 23, 0, &A0, sid; &48, 28, scalez; : Set Scene Z Scale Factor
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 28 ; command 28: set scene z scale factor
@scalez: dw 0x0000
@end: db 0x00 ; padding

; Set Scene XYZ Scale Factors
; VDU 23, 0, &A0, sid; &48, 29, scalex; scaley; scalez; : Set Scene XYZ Scale Factors
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 29 ; command 29: set scene xyz scale factors
@scalex: dw 0x0000
@scaley: dw 0x0000
@scalez: dw 0x0000
@end: db 0x00 ; padding
; Set Scene X Rotation Angle
; VDU 23, 0, &A0, sid; &48, 30, anglex; : Set Scene X Rotation Angle
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 30 ; command 30: set scene x rotation angle
@anglex: dw 0x0000
@end: db 0x00 ; padding

; Set Scene Y Rotation Angle
; VDU 23, 0, &A0, sid; &48, 31, angley; : Set Scene Y Rotation Angle
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 31 ; command 31: set scene y rotation angle
@angley: dw 0x0000
@end: db 0x00 ; padding

; Set Scene Z Rotation Angle
; VDU 23, 0, &A0, sid; &48, 32, anglez; : Set Scene Z Rotation Angle
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 32 ; command 32: set scene z rotation angle
@anglez: dw 0x0000
@end: db 0x00 ; padding

; Set Scene XYZ Rotation Angles
; VDU 23, 0, &A0, sid; &48, 33, anglex; angley; anglez; : Set Scene XYZ Rotation Angles
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 33 ; command 33: set scene xyz rotation angles
@anglex: dw 0x0000
@angley: dw 0x0000
@anglez: dw 0x0000
@end: db 0x00 ; padding
; Set Scene X Translation Distance
; VDU 23, 0, &A0, sid; &48, 34, distx; : Set Scene X Translation Distance
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 34 ; command 34: set scene x translation distance
@distx: dw 0x0000
@end: db 0x00 ; padding

; Set Scene Y Translation Distance
; VDU 23, 0, &A0, sid; &48, 35, disty; : Set Scene Y Translation Distance
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 35 ; command 35: set scene y translation distance
@disty: dw 0x0000
@end: db 0x00 ; padding

; Set Scene Z Translation Distance
; VDU 23, 0, &A0, sid; &48, 36, distz; : Set Scene Z Translation Distance
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 36 ; command 36: set scene z translation distance
@distz: dw 0x0000
@end: db 0x00 ; padding

; Set Scene XYZ Translation Distances
; VDU 23, 0, &A0, sid; &48, 37, distx; disty; distz; : Set Scene XYZ Translation Distances
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 37 ; command 37: set scene xyz translation distances
@distx: dw 0x0000
@disty: dw 0x0000
@distz: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 38 ; command 38: render to bitmap
@bmid: dw 0x0000
@end: db 0x00 ; padding
...
@beg: db 23, 0, $A0
@sid: dw sid
@cmd: db $48, 39 ; command 39: delete control structure
@end: 
