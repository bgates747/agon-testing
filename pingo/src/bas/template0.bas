  ...
  51 camf=32767.0/256.0
  52 camx=0.0*camf: camy=0.0*camf: camz=-10.0*camf
  53 pi2=PI*2.0: camanglef=32767.0/pi2
  54 camanglex=0.0*camanglef
  56 scale=1.0*256.0
  57 rotatex=0.0: rotatey=0.0: rotatez=0.0
  58 rfactor=32767.0/pi2
  59 inc=0.122718463
  60 incx=inc:incy=0.0:incz=0.0
  61 scene_width%=320: scene_height%=240
   69 VDU 17, 4+128 : REM SET TEXT BACKGROUND COLOR TO DARK BLUE
  ...
  290 VDU 23,0, &A0, sid%; &49, 25, camx; camy; camz;
  315 PRINT "Set Camera X Rotation Angle"
  320 VDU 23,0, &A0, sid%; &49, 18, camanglex;
 ...
 1160 rx=rotatex*rfactor: ry=rotatey*rfactor: rz=rotatez*rfactor
