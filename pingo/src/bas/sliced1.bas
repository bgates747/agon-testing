  ...
  920 REM VDU 23, 0, &C3: REM Flip buffer
  ...
  960 REM VDU 17,7+128 : REM set text background color to light gray
  970 REM VDU 18, 0, 7+128 : REM set gfx background color to light gray
  980 REM --== MAIN LOOP ==--
  990 REM CLS
...
2000 REM -- VERTICES --
2002 DATA 0.0, 0.0, 0.0
2004 DATA 0.0, -1.0, 0.0
2006 DATA 0.0, 0.0, -1.0
2008 DATA 1.0, 0.0, 0.0
